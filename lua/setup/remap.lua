...
vim.keymap.set("i", "<Esc>", "<Esc>l",{noremap = true, silent = true}) -- Move cursor to the right when exiting insert mode
...
vim.keymap.set("i", "<C-v>", "<Esc>pa") -- Put from buffer (insert mode)
